...
public class EventValidator {
    ...
    /**
     * Check if the event type is valid or not
     * @param eventType Type of the event
     * @return True if event type is valid, otherwise false
     */
    public boolean validateEventType(String eventType) {
        boolean isEventTypeValid = switch (eventType) {
            case "GamesNight", "MondayNightMeal", "MovieNight", "SnowballFight", "CanadaDayFireworks" -> true;
            default -> false;
        };
        if (!isEventTypeValid) {
