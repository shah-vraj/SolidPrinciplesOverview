...
public class JitsiMeet implements OnlineMeeting {
    ...
    @Override
    public void admitUser(String roomName, int userId) {
        System.out.println("Admitting user " + userId + " to room " + roomName);
    }
    ...
    @Override
    public void removeUser(String roomName, int userId) {
        System.out.println("Removing user " + userId + " from room " + roomName);
    }
