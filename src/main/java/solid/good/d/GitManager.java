...
public class GitManager {
    ...
    private final RemoteGitProvider remoteGitProvider;
    ...
    public GitManager(RemoteGitProvider remoteGitProvider) {
        this.remoteGitProvider = remoteGitProvider;
        this.remoteGitProvider.loginUser();
    }
    ...
    public void addRemote(String remoteUrl) {
        if (remoteGitProvider.doesRemoteExists(remoteUrl)) {
    ...
    public void shareProject(String projectName) {
        String newRepositoryUrl = remoteGitProvider.createNewRepository(projectName);
    ...
    public void deleteRepository(String repositoryName) {
        remoteGitProvider.deleteRepository(repositoryName);
    ...
    public void fetchChanges() {
        bufferedFiles = new ArrayList<>(remoteGitProvider.fetchChanges());
    }
    ...
    public void pushChanges() {
        ...
        remoteGitProvider.pushChanges(committedFiles);
    }
