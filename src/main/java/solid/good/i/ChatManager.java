...
import solid.good.i.message.EditedMessage;
import solid.good.i.message.Message;
import solid.good.i.message.NormalMessage;
import solid.good.i.message.RepliedMessage;
...
public class ChatManager {
    ...
    /**
     * Provides the Message for the requesting message ID
     * @param messageId ID of the message
     * @return Message object
     */
    public Message getMessage(int messageId) {
        Pair<Participant, Message> chatMessage = getChatMessage(messageId);
        return chatMessage != null ? chatMessage.second() : null;
    }
